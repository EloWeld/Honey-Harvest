    ...
    <PixelPanel type={'market'} resolution='1.4rem'>
      <div className="market-item-content flex items-center justify-between p-2 h-full">
        <div className="flex items-center">
          ...
          <div>
            <OutlinedText className="text-xl sm:text-3xl font-bold" text={name}/>
            <OutlinedText className="text-sm sm:text-lg" text={"+" + ton + "TON"} />
            <OutlinedText className="text-sm sm:text-lg" text={"+" + honey + "Honey"} />
          </div>
        </div>
