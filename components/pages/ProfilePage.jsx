    ...
    <div className='modal'>
      <div className='modalbig-top-panel'>
        ...
        <div className='flex flex-row justify-between'>
          ...
          <OutlinedText className='text-xl' text={user.earnedTON} />
          <img src="/images/icons/ton.png" alt="TON" className="w-5 h-5" />
          </div>
        </div>
        <div className='flex flex-row justify-between'>
          <OutlinedText className='text-xl' text={"Количество пчёл :"} />
          <OutlinedText className='text-xl' text={user.bees.length} />
        </div>
        <div className='flex flex-row justify-between'>
          <OutlinedText className='text-xl' text={"Приглашено людей :"} />
          <OutlinedText className='text-xl' text={user.referralsCount} />
        </div>
        {!user.tonWallet && (<button className='h-10 w-full self-center silly-scale'>
