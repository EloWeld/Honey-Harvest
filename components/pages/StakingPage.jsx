    ...
    <div className='modal'>
      <div className='modalbig-top-panel'>
        <div className='flex flex-row justify-between items-center'>
          <OutlinedText className='text-5xl' text={"Staking"} />
        ...
        <div className='flex flex-row justify-between gap-6 items-center'>
          ...
          <div className='flex flex-row items-center gap-3'><OurIcon icon='ton' /><OutlinedText className='text-xl' text={"20.3"} /></div>
        </div>
        <div className='flex flex-row justify-between gap-6 items-center'>
          ...
          <button className='w-30 relative silly-scale'>
            <PixelPanel resolution='15px' className2='' className='align-center'>
              <OutlinedText className="text-3xl font-bold text-center px-4 py-1" centered={true} text={"Стейк"} />
            </PixelPanel>
          </button>
        </div>

        <div className='flex flex-row justify-between gap-6 items-center'>
          <OutlinedText className='text-xl' text={"Вы получите :"} />
          <div className='flex flex-row items-center gap-3'><OurIcon icon='ton' /><OutlinedText className='text-xl' text={"23.3"} /></div>
        </div>

      </div>
      <div className='modalbig-bottom-panel'>
        <div className='flex flex-row justify-between gap-6 items-center'>
          <OutlinedText className='text-xl' text={"Застейкано :"} />
          <div className='flex flex-row items-center gap-3'><OurIcon icon='ton' /><OutlinedText className='text-xl' text={"23.3"} /></div>
        </div>
        <div className='flex flex-row justify-between gap-6 items-center'>
          <OutlinedText className='text-xl' text={"Осталось :"} />
          <div className='flex flex-row items-center gap-3'><OurIcon icon='ton' /><OutlinedText className='text-xl' text={"23.3"} /></div>
        </div>
        <div className='flex flex-row justify-between gap-6 items-center'>
          <OutlinedText className='text-xl' text={"Вы получите :"} />
